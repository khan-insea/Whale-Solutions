...
export const FAQS = [
  {
    question: 'whale sea là công ty hay là cá nhân?',
    answer: 'whale sea hoạt động dưới mô hình Freelance Studio / Solo Digital Service Provider do một Solo Founder cùng mạng lưới các cộng tác viên giỏi chuyên môn vận hành. Nhờ tối ưu hóa chi phí mặt bằng và nhân sự cố định, chúng tôi cung cấp mức phí rất cạnh tranh và dịch vụ cực kỳ tận tâm trực tiếp từ người làm chuyên môn chi tiết nhất.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Mọi dự án từ whale sea đều dựa trên thỏa thuận dịch vụ rõ ràng, chia tiến độ thanh toán theo cột mốc cụ thể (ví dụ: cọc 30%, nghiệm thu giai đoạn 40% và thanh toán nốt sau bàn giao chạy thử). Bạn luôn được kiểm tra, review tiến độ qua Link Demo trực tiếp trước khi thanh toán mốc tiếp theo.'
  },
  {
    question: 'Thông tin yêu cầu tư vấn báo giá của tôi sẽ đi về đâu?',
    answer: 'Ngay khi bạn điền biểu mẫu nhận báo giá, một email ghi nhận chi tiết sẽ được tự động chuyển tiếp tới hòm thư quản lý của whale sea. Solo Founder sẽ liên hệ tư vấn, gửi file báo giá kỹ thuật chi tiết nhất qua Zalo hoặc Email của bạn trong vòng tối đa 4 giờ làm việc!'
  }
];
